  ...
  <div className="p-5 font-sourcecode">
    <div className="flex justify-center space-x-6">
      <a
        ...
        className="text-gray-400 transition ease-in hover:text-gray-500"
        target="_blank"
        rel="noreferrer"
        title="GitHub"
      >
      ...
      <a
        ...
        className="m-auto text-gray-400 transition ease-in hover:text-gray-500"
        target="_blank"
        rel="noreferrer"
        title="LinkedIn"
      >
    ...
    <p className="flex justify-center pt-2 mt-5 text-sm text-gray-500">
